"use client";
import { Note, columns } from "@/app/[locale]/table-virtual/_components/columns";
import { VirtualRowDataTable } from "@/components/table/virtual-row-table";
...
function Page() {
  ...
  const fakeData: Note[] = Array(10000)
    .fill(1)
    .map((_, index) => ({
      book: [],
      book_id: index,
