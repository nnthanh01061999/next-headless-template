...
import AsyncCombobox, { AsyncComboboxProps } from "@/components/ui/async-combobox";
import { cn } from "@/lib/utils";
import { TFormProps } from "@/types/form";
import { useFormContext } from "react-hook-form";

export type TFormAsyncComboboxProps = {
  childProps: Omit<AsyncComboboxProps, "value" | "onChange" | "options" | "valueMode">;
} & TFormProps;
      ...
      render={({ field }) => {
        ...
        return (
          <FormItem className={styles?.itemClass}>
            ...
            <FormControl>
              <AsyncCombobox {...childProps} ref={ref} valueMode="object" value={value} onChange={onChange} onBlur={onBlur} />
            </FormControl>
